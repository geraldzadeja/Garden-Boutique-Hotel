...
function BookingContent() {
  ...
  const countryCodes = [
    ...
    { code: '+1-268', country: 'Antigua and Barbuda', iso2: 'ag' },
    ...
    { code: '+1-242', country: 'Bahamas', iso2: 'bs' },
    { code: '+973', country: 'Bahrain', iso2: 'bh' },
    { code: '+880', country: 'Bangladesh', iso2: 'bd' },
    { code: '+1-246', country: 'Barbados', iso2: 'bb' },
    ...
    { code: '+238', country: 'Cabo Verde', iso2: 'cv' },
    ...
    { code: '+243', country: 'Congo (DRC)', iso2: 'cd' },
    ...
    { code: '+383', country: 'Kosovo', iso2: 'xk' },
    ...
    { code: '+1-784', country: 'Saint Vincent', iso2: 'vc' },
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    >
                      {nationality ? (
                        <>
                          <span className={`fi fi-${nationalities.find(c => c.country === nationality)?.iso2} text-[18px] flex-shrink-0`}></span>
                    ...
                    {isNationalityOpen && (
                      <>
                        ...
                        <div className="absolute left-0 top-full mt-1 w-full max-h-[300px] overflow-y-auto bg-white border border-[#e5e5e5] rounded-sm shadow-lg z-20">
                          {nationalities.map(({ country, iso2 }) => (
                            <button
                              key={`${country}-${iso2}`}
                              type="button"
